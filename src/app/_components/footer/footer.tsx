    ...
    <>
      <footer className="bg-[#F0F3F2] static end-0 start-0 bottom-0 font-outfit py-10">
        <div className="w-[90%] mx-auto">
          <h1 className="text-[#01854c] font-bold text-2xl">
          ...
          <div className="my-5 flex mb-10">
            ...
            <button
              type="button"
              className="text-white md:w-50 bg-[#00cc74] hover:bg-[#00C88C] shadow-xs font-medium leading-5 px-5 text-md rounded-sm  ms-2 cursor-pointer"
            >
              Share App Link
            </button>
          </div>
          ...
          <div className="items-center justify-between py-5">
            <div className="flex items-center">
              <div className="w-40 md:w-full">
                <h4 className="text-[#01854c] me-5">Payment Partners</h4>
              </div>
              <Link href="">
