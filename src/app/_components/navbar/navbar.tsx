    ...
    <>
      <nav className=" bg-[#F0F3F2] font-outfit fixed mx-auto  z-20 top-0 start-0 end-0">
        <div className="max-w-7xl flex flex-wrap md:flex-nowrap justify-between items-center  mx-auto p-4 w-[90%]">
          <Link
            href="/"
            className="flex items-center space-x-3 rtl:space-x-reverse text-[#00cc74] text-2xl"
          >
            <i className="fa-brands fa-opencart text-primary mr-2"></i>
            <span className="font-bold text-2xl font-semiblod text-[#01854c] self-center whitespace-nowrap">
              FreshCart
            </span>
          </Link>

          <div className="flex items-center text-[#01854c]">
            <div className="flex ms-4 items-center">
              <div className="relative">
                <span className="text-sm font-semibold bg-[#00CC74] text-white rounded-full px-2  absolute -top-3 z-40 -start-2">
                  {numOfWishList.count}
                </span>
                <Link href="/wishlist">
                  <i className="fa-solid fa-heart pe-8 text-lg hover:text-green-500 hover:animate-shake"></i>
                </Link>
              </div>
              <div className="relative">
                <span className="text-sm font-semibold bg-[#00CC74] text-white rounded-full px-2  absolute -top-4 -start-2">
                  {numOfCartItems}
                </span>
            ...
            <button
              ...
              type="button"
              className="inline-flex items-center text-[#01854c]  lg:hidden cursor-pointer"
              ...
              <div>
                <ul className="font-normal text-center  flex flex-col p-4 md:p-0 mt-4  border-default rounded-base bg-[#F0F3F2] md:flex-row md:space-x-4 rtl:space-x-reverse md:mt-0 md:ms-7 md:border-0 md:bg-[#F0F3F2]">
                  <li>
                    <Link
                      href="/"
                      className="block py-2 px-3 text-gray-500  rounded md:bg-transparent md:text-[#00cc74] md:font-black md:p-0"
                      aria-current="page"
                    >
                      Home
                    </Link>
                  ...
                  <li>
                    <Link
                      href="/products"
                      className="block py-2 px-3 text-gray-500 rounded hover:bg-neutral-tertiary md:hover:bg-transparent md:border-0 md:hover:text-[#00cc74] transition: duration-400 md:p-0 md:dark:hover:bg-transparent"
                    >
                      Products
                    </Link>
                  </li>
              ...
              <div className="text-center md:flex">
                <div>
                  ...
                  <Link href="https://x.com">
                    <i className="me-2 fa-brands fa-x-twitter text-[#01854c] hover:-translate-y-1 duration-300"></i>
                  </Link>
