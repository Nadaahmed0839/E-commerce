        ...
        >
          <SwiperSlide className="relative w-3/4">
            ...
            <div className="absolute top-3 z-30 ms-7">
              <div className="bg-white w-54 text-3xl font-extrabold text-[#01854c] rounded-4xl py-1.5">
                <h1 className="text-center">
                  <i className="fa-brands fa-opencart text-[#00cc74] me-3"></i>
                  Fresh Cart
                </h1>
              </div>
              ...
              <button className="bg-[#00cc74] hover:bg-[#00C88C] cursor-pointer text-white px-10 py-2 rounded-4xl">
                Get Started
              </button>
            </div>
          </SwiperSlide>
