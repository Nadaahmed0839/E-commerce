      ...
      <div className="w-[90%] mx-auto font-outfit py-25 md:py-20">
        <div className="md:flex">
          ...
          <div className="mt-15 md:w-3/4">
            <h4 className="mb-2 text-[#01854c] text-3xl font-bold cursor-pointer">
              {data.title.slice(0, 15)}
            </h4>
            <h4 className="mb-1 text-[#00cc74] text-[14px] font-semibold">
              {data.category.name}
            </h4>
            ...
            <h4 className="me-5">
              ...
              <span className="text-[#01854c]">{data.ratingsAverage}</span>
            </h4>
            <p className="text-gray-500 py-4">{data.description}</p>
            <h4 className="text-[#00cc74] font-semibold text-[18px]">
              EGP {data.price}
            </h4>
          ...
          <Link href="/products">
            <button className="bg-[#00cc74] absolute end-5 -bottom-30 md:top-20 md:bottom-122 px-3 py-2 cursor-pointer rounded-full me-3 text-white mt-17 hover:scale-105 hover:-translate-x-1 duration-300">
