              ...
              <div className="relative group">
                <Link href={`/products/${currentProduct.id}`}>
                  <Card className="relative border-0 mx-auto w-full pt-0">
                    ...
                    <CardHeader>
                      <CardDescription>
                        <div className="mb-2 text-[#00cc74] hover:text-[#f97316] duration-300 mt-5 text-[16px] cursor-pointer line-clamp-1">
                          <h4>{currentProduct.slug}</h4>
                        </div>
                        <div className="mb-2 text-[#01854c] font-semibold text-[16px]">
                        ...
                        <div className="flex justify-between">
                          <h4 className="text-[#00cc74]">
                            EGP {currentProduct.price}
                          </h4>
                          <h4 className="me-5 text-[#01854c]">
                  ...
                  <div className="flex gap-4">
                    ...
                    <Link href={`/products/${currentProduct.id}`}>
                      <Button className="flex gap-4 pointer-events-auto">
                        <span className="bg-[#11c074c2] hover:bg-[#01854C] cursor-pointer duration-300 rounded-full p-3">
