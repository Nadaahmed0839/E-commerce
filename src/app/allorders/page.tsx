  ...
  return (
    <div className="mt-20 mb-10 md:mt-30 w-[90%] mx-auto font-outfit">
      <div className="flex mb-10">
        ...
        <h3 className="text-2xl font-bold text-[#01854c]">
          Track your orders
          <i className="fa-solid fa-truck-fast ms-2 text-[#00cc74] font-black"></i>
        </h3>
      </div>
            ...
            <div key={currentorder.id}>
              <div className="border-2 border-dotted p-4 rounded-2xl border-gray-300 my-5">
                <div className="flex justify-between mt-10">
                  <div className="text-[#01854c] md:flex md:gap-x-15">
                  ...
                  <div>
                    <Link href="/products">
                      <button className="bg-[#00cc74] hover:bg-[#00C88C] cursor-pointer rounded-md text-white py-1 px-2 text-sm">
                        Add New Items
                      </button>
                    </Link>
                  </div>
                    ...
                    return (
                      <div key={currentItem.product.id}>
                        <div className="relative flex items-center mb-5">
                          ...
                          <div className="ms-5">
                            <h4 className="font-medium text-[#01854c] mb-10  hover:text-[#00cc74] duration-300">
                              {currentItem.product.title}
                            </h4>
                            <h4 className="text-[#01854c] mb-1">
                              Price :
                              <span className="text-[#00cc74] ms-1 mb-1">
                                EGP {currentItem.price}
                              </span>
                            </h4>
                            <h4 className="text-[#01854c] mb-2">
                              Quantity :{" "}
                ...
                <div>
                  <h4 className="text-[#01854c] font-semibold mb-1">
                    Products Quantity :
                    <span className="text-[#00cc74] ms-1 mb-1">
                  ...
                  <h4 className="text-[#01854c] font-semibold text-xl mb-1">
                    Total Order Price :
                    <span className="text-[#00cc74] ms-1 mb-1">
