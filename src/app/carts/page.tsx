  ...
  return (
    <div className="bg-[#F0F3F2] mt-20 mb-10 md:mt-25 py-10 rounded-3xl  w-[95%] md:w-[85%] font-outfit container mx-auto overflow-auto">
      <div className="flex items-center w-[90%] md:w-[95%] mx-auto">
        <Link href="/products">
          <button className="bg-[#00cc74] me-5  px-2 py-1 cursor-pointer rounded-full  text-white hover:scale-105 hover:-translate-x-1 duration-300">
            <i className="fa-solid fa-arrow-left text-sm"></i>
          </button>
        </Link>
        <h3 className="text-2xl font-bold text-[#01854c]">Shop Cart</h3>
        <i className="fa-brands fa-opencart text-primary ms-2 text-[20px] text-[#00cc74]"></i>
      </div>

      {numOfCartItems <= 0 ? (
        <div className="text-center py-20">
          <h3 className="text-[#01854c] mb-3 font-medium">
            There are no items yet.
          </h3>
          <Link href="/products">
            <button
              type="button"
              className="text-white bg-[#00cc74] hover:bg-[#00C88C] cursor-pointer  text-md rounded-md px-6 py-2"
            >
        ...
        <div className="w-[90%] mx-auto">
          <div className="flex flex-col items-end justify-end -my-7">
            <h4 className="text-[#01854c] font-semibold mb-2">
              Total Price <span className="ms-1">:</span>
              <span className="text-[#00cc74]  ms-2">
                EGP {cartData?.totalCartPrice}
              </span>
            </h4>
            <button className="text-xs text-[#00cc74] outline-1 cursor-pointer outline-gray-800 rounded-sm mx-10 p-1 bg-white">
            ...
            return (
              <div key={item.product._id} className="flex mt-20 mb-10">
                ...
                <div className="ms-15 w-full">
                  <h2 className="text-[#01854c] text-xl font-bold mb-2">
                    {item.product.title}
                  </h2>
                  <h5 className="text-[#01854c] mb-2">
                    Rate :
                    <i className="fa-solid fa-star text-[#ffc908] me-1 ms-2"></i>
                    <span className="text-[#00cc74]">
                  ...
                  <div className="flex justify-between items-center">
                    <div className="">
                      <button
                        type="button"
                        className="outline-2 flex items-center font-bold text-[#01854c] outline-gray-400 py-1 px-3  rounded-2xl"
                    ...
                    <div className="text-xs font-medium ">
                      <h6 className="text-[#01854c]">Total Price</h6>
                      <h6 className="text-[#00cc74]">EGP {item.price}</h6>
                    </div>
                    <button
                      type="button"
