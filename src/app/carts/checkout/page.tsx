    ...
    <>
      <div className="bg-[#F0F3F2] mx-5 rounded-lg">
        <div className="w-[90%] pt-20 pb-10 mt-25 mb-10  mx-auto">
          <h2
            className="relative text-[#01854c] text-lg font-bold text-center mb-15
before:content-[''] before:absolute before:left-1/2 before:-translate-x-1/2
before:-top-3 before:w-32 md:before:w-48 before:h-0.5 before:bg-[#00cc74]

after:content-[''] after:absolute after:left-1/2 after:-translate-x-1/2
after:-bottom-3 after:w-32 md:after:w-48 after:h-0.5 after:bg-[#00cc74]
"
          >
            Check Out
          </h2>
          ...
          <div className="border border-gray-300 rounded-md p-5">
            <h3 className="text-lg font-bold text-[#01854c] mb-5">
              Cart totals
            </h3>
            <div className="ms-2">
              <h5 className="font-bold text-[#01854c]">
                SubTotal <span className="ms-1">:</span>{" "}
                <span className="ms-3 text-[#00cc74]">
                ...
                >
                  ...
                  <div className="ms-2">
                    <Button
                      ...
                      type="submit"
                      className=" text-white flex items-center justify-center w-full mb-5 bg-[#00cc74] box-border border border-transparent hover:bg-[#00C88C] cursor-pointer  duration-300   font-medium  rounded-base text-md px-2 py-1.5 focus:outline-none"
                    >
                      <Image
                        width={40}
                        height={10}
                    ...
                    <Button
                      ...
                      type="submit"
                      className="text-[#01854c] w-full flex items-center justify-center bg-white box-border border border-transparent hover:bg-[#00cc74] cursor-pointer hover:text-white duration-300 focus:ring-4 focus:ring-success-medium shadow-xs font-medium leading-5 rounded-base text-md px-4 py-1.5"
                    >
                      <Image
                        width={40}
                        height={10}
